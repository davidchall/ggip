...
The `coord_ip()` function configures the mapping of IP data to the 2D grid (addresses to points and networks to rectangles).
This is fundamental to every ggip plot.
